...
Accessibility is a way to make sure your website is accessible for everyone, no matter how they are accessing the web. 
2. Talk about 3 different things you can do to ensure your website is accessible. 
Run a screen reader to see if it makes sense to people using one, make sure the colors are complementary and not too hard to see for color blind people, make sure to use scalable units. 
3. How would you explain the concept of a variable to someone new to programming?
A variable is a storage container for data. 
4. What is the purpose of using functions in code?
Functions are like mini programs that make certain data reusable or changeable depending on the need. 
